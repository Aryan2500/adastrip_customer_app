...
import 'package:adastrip/model/payment_setting_model.dart';
...
class Constant {
  ...
  static String placeholderUrl =
      'https://adastrip.com/assets/images/placeholder_image.jpg';
  ...
  Future<Map<String, dynamic>> getOSMAddressFromLatLong(
    ...
    var package =
        Platform.isAndroid ? 'com.adastrip.driver' : 'com.adastrip.driver.ios';
