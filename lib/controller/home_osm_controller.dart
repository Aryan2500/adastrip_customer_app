...
import 'package:adastrip/model/banner_model.dart';
import 'package:adastrip/model/driver_location_update.dart';
import 'package:adastrip/model/driver_model.dart';
import 'package:adastrip/model/payment_method_model.dart';
import 'package:adastrip/model/vehicle_category_model.dart';
import 'package:adastrip/page/rent_vehicle_screens/rent_vehicle_screen.dart';
...
class HomeOsmController extends GetxController with GetSingleTickerProviderStateMixin {
  ...
  getCurrentAddress({bool setMarker = false}) async {
    ...
    if (Constant.selectedMapType == 'osm') {
      ...
      var package = Platform.isAndroid ? 'com.adastrip' : 'com.adastrip.ios';
