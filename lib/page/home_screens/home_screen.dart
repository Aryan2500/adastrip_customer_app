...
import 'package:adastrip/constant/constant.dart';
import 'package:adastrip/constant/show_toast_dialog.dart';
import 'package:adastrip/controller/dash_board_controller.dart';
import 'package:adastrip/controller/home_controller.dart';
import 'package:adastrip/controller/parcel_service_controller.dart';
import 'package:adastrip/model/driver_model.dart';
import 'package:adastrip/model/vehicle_category_model.dart';
import 'package:adastrip/page/dash_board.dart';
import 'package:adastrip/page/home_screens/loading_screen.dart';
import 'package:adastrip/page/home_screens/sucess_screen.dart';
import 'package:adastrip/page/parcel_service_screen/book_parcel_screen.dart';
import 'package:adastrip/themes/button_them.dart';
import 'package:adastrip/themes/constant_colors.dart';
import 'package:adastrip/themes/radio_button.dart';
import 'package:adastrip/themes/responsive.dart';
import 'package:adastrip/themes/text_field_them.dart';
import 'package:adastrip/utils/Preferences.dart';
import 'package:adastrip/utils/dark_theme_provider.dart';
import 'package:adastrip/widget/StarRating.dart';
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              prefix: IconButton(
                                                                                ...
                                                                                icon: Text(
                                                                                  ...
                                                                                  style: TextStyle(fontSize: 16, fontFamily: AppThemeData.regular, color: themeChange.getThem() ? AppThemeData.grey500Dark : AppThemeData.grey500),
                                                                                ),
                                                                              ),
                                                                    ...
                                                                    if (value !=
                                                                      ...
                                                                      if (value[
                                                                        ...
                                                                        if (Constant.distanceUnit ==
                                                                          ...
                                                                          controller
                                                                              .distance
                                                                              .value = durationValue['rows'].first['elements'].first['distance']
                                                                                  ['value'] /
                                                                              1000.00;
                                                                        } else {
                                                                          controller
                                                            ...
                                                            Container(
                                                              ...
                                                              child: ListView
                                                                  .separated(
                                                                      ...
                                                                      shrinkWrap:
                                                                          true,
                                                                      itemCount: parcelServiceController
                                                                          .parcelCategoryList
                                                                          .length,
                                                                      itemBuilder:
                                                                        ...
                                                                        return InkWell(
                                                                          ...
                                                                          onTap:
                                                                              () {
                                                                            parcelServiceController.selectedParcelCategory.value =
                                                                                parcelServiceController.parcelCategoryList[index];
                                                                            Get.to(() =>
