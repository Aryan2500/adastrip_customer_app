...
import 'package:adastrip/constant/logdata.dart';
import 'package:adastrip/constant/show_toast_dialog.dart';
import 'package:adastrip/controller/payment_controller.dart';
import 'package:adastrip/controller/wallet_controller.dart';
import 'package:adastrip/model/payStackURLModel.dart';
import 'package:adastrip/model/razorpay_gen_orderid_model.dart';
import 'package:adastrip/model/stripe_failed_model.dart';
import 'package:adastrip/model/tax_model.dart';
import 'package:adastrip/model/user_model.dart';
import 'package:adastrip/model/xenditModel.dart';
import 'package:adastrip/page/wallet/midtrans_screen.dart';
import 'package:adastrip/page/wallet/orangePayScreen.dart';
import 'package:adastrip/page/wallet/payStackScreen.dart';
import 'package:adastrip/page/wallet/xenditScreen.dart';
import 'package:adastrip/service/api.dart';
import 'package:adastrip/themes/appbar_cust.dart';
                    ...
                    Padding(
                        ...
                        child: ButtonThem.buildButton(context, title: "Pay ${Constant().amountShow(amount: controller.getTotalAmount().toString())}".tr, onPress: () async {
                          if (controller.selectedRadioTile.value == "Wallet") {
                            ...
                            stripe1.Stripe.merchantIdentifier = 'adastrip';
