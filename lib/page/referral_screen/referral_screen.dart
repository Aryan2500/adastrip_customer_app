...
import 'package:adastrip/controller/referral_controller.dart';
...
class _ReferralScreenState extends State<ReferralScreen> {
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Earn rewards by inviting your friends to adastrip".tr,
  ...
  Future<void> share(ReferralController referralController) async {
    ...
    await Share.share(
      "${"Hey there, thanks for choosing adastrip. Hope you love our product. If you do, share it with your friends using code".tr} ${referralController.referralCode.toString()} ${"and get".tr} ${Constant().amountShow(amount: referralController.referralAmount.toString())} ${"when ride completed".tr}",
    );
    // await FlutterShare.share(
    //   title: 'adastrip',
    //   text:
    //       'Hey there, thanks for choosing adastrip. Hope you love our product. If you do, share it with your friends using code ${referralController.referralCode.toString()} and get ${Constant().amountShow(amount: referralController.referralAmount.toString())} when ride completed',
    // );
  }
}
