...
import 'package:adastrip/page/home_screens/home_osm_screen.dart';
import 'package:adastrip/page/home_screens/home_screen.dart';
...
class DashBoard extends StatelessWidget {
    ...
    return GetBuilder<DashBoardController>(
      ...
      builder: (controller) {
        ...
        return WillPopScope(
          ...
          child: Scaffold(
            body: (Constant.selectedMapType == 'osm' && controller.selectedDrawerIndex.value == 0) ? const HomeOSMScreen() : const HomeScreen(),
          ),
        );
      },
    );
  ...
  // buildAppDrawers(BuildContext context, DashBoardController controller) {
                ...
                Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                  SvgPicture.asset(
                    ...
                    colorFilter: ColorFilter.mode(
                      controller.drawerItems[i].title == controller.drawerItems[controller.drawerItems.length - 1].title
                  ...
                  Text(
                    d.title,
                    style: TextStyle(
                      color: controller.drawerItems[i].title == controller.drawerItems[controller.drawerItems.length - 1].title
                          ? AppThemeData.error200
                          : controller.selectedDrawerIndex.value == i
                              ? AppThemeData.primary200
                              : themeChange.getThem()
