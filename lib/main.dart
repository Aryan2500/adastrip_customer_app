...
import 'package:adastrip/controller/settings_controller.dart';
import 'package:adastrip/firebase_options.dart';
...
import 'package:adastrip/themes/styles.dart';
...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  Future<void> setupInteractedMessage(BuildContext context) async {
    initialize(context);
    await FirebaseMessaging.instance.subscribeToTopic("adastrip_customer");
